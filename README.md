...
| **Students & academics** | Learn how the world's best problem-solvers actually think |
...
- Healthcare & Life Sciences (hospital P&L, pharma pipeline, FDA, CMS)
- Financial Services (NIM, ROE, Basel IV, insurance, fintech)
- Energy & Utilities (LCOE, IRA, energy transition, FERC)
- Technology, Media & Telecom (SaaS unit economics, platform dynamics, 5G)
- Consumer, Retail & CPG (GMROI, trade spend, DTC disruption)
- Industrial & Manufacturing (OEE, Lean/TPS, S&OP, Industry 4.0)
- Public Sector & Defense (FAR/DFARS, GovCon, IDIQ)
- Real Estate & Infrastructure (cap rates, NOI, REPE, REIT)
- Hospitality & Travel (RevPAR, ADR, airline CASK)

### Specialist Methods
- Due diligence (commercial, operational, financial, ESG)
- Post-merger integration (IMO, synergy framework, Day 1 readiness)
- Corporate restructuring & financial distress (Chapter 11, DIP, 13-week cash flow)
- GenAI enterprise strategy (pilot purgatory, RAG, LLMOps, EU AI Act)
- Pricing & revenue management (conjoint, Van Westendorp, price waterfall)
- Org design & workforce planning (Galbraith Star, spans & layers, SBO)
- Change management (ADKAR, Kotter, resistance management)
- Climate strategy & net-zero (SBTi, MAC curves, CSRD, CBAM)
